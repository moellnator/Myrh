...
Namespace Rendering.Projections
    Public Class P3DOrthographic : Inherits Projection
        ...
        Public Sub New(Max As Single, Aspect As Single, Near As Single, Far As Single)
            Me._n = Near
            Me._f = Far
            Me._t = Max
            Me._b = -Me._t
        ...
        Public Overrides Function Project(v As Vertex) As Vertex
            Dim c As New Vertex(
                v.X * 2 / (_r - _l) - v.W * (_r + _l) / (_r - _l),
                v.Y * 2 / (_t - _b) - v.W * (_t + _b) / (_t - _b),
